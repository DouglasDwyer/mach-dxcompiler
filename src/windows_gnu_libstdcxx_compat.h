// Force-included (via -include) into every C++ translation unit when building windows-gnu
// against the host's libstdc++ instead of Zig's bundled libc++.
//
...
// restore it here.
#ifndef MACH_DXCOMPILER_WINDOWS_GNU_LIBSTDCXX_COMPAT_H
#define MACH_DXCOMPILER_WINDOWS_GNU_LIBSTDCXX_COMPAT_H
